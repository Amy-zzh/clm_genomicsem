...
--chr $i \
--beqtl-summary /media/user/Lenovo/GSEM/SMR/LBC_BSGS_meta_lite/bl_mqtl_lite_chr$i \
--out /media/user/Lenovo/GSEM/SMR/Results/CLM_BF_LBC_smr_multi_chr$i \
--smr-multi
done
...
--chr $i \
--beqtl-summary /media/user/Lenovo/GSEM/SMR/LBC_BSGS_meta_lite/bl_mqtl_lite_chr$i \
--out /media/user/Lenovo/GSEM/SMR/Results/CLM_F1_LBC_smr_multi_chr$i \
--smr-multi
done
...
--chr $i \
--beqtl-summary /media/user/Lenovo/GSEM/SMR/LBC_BSGS_meta_lite/bl_mqtl_lite_chr$i \
--out /media/user/Lenovo/GSEM/SMR/Results/CLM_F2_LBC_smr_multi_chr$i \
--smr-multi
done
...
--chr $i \
--beqtl-summary /media/user/Lenovo/GSEM/SMR/LBC_BSGS_meta_lite/bl_mqtl_lite_chr$i \
--out /media/user/Lenovo/GSEM/SMR/Results/CLM_F3_LBC_smr_multi_chr$i \
--smr-multi
done
...
--chr $i \
--beqtl-summary /media/user/Lenovo/GSEM/SMR/LBC_BSGS_meta_lite/bl_mqtl_lite_chr$i \
--out /media/user/Lenovo/GSEM/SMR/Results/CLM_F4_LBC_smr_multi_chr$i \
--smr-multi
done
