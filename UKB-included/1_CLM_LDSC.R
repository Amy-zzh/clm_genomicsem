...
traits<-c("AF.sumstats.gz","HF.sumstats.gz","Stroke.sumstats.gz","PAD.sumstats.gz","CAD.sumstats.gz","VHD.sumstats.gz","NAFLD2.sumstats.gz","PDFF.sumstats.gz","CT1.sumstats.gz","ALT.sumstats.gz","AST.sumstats.gz","GGT.sumstats.gz","ALP.sumstats.gz","BMI.sumstats.gz","WC.sumstats.gz","BFP.sumstats.gz","T2D.sumstats.gz","FG.sumstats.gz","HbA1c.sumstats.gz","HTN.sumstats.gz","SBP.sumstats.gz","DBP.sumstats.gz","nonHDL.sumstats.gz","LDL.sumstats.gz","HDL.sumstats.gz","logTG.sumstats.gz","RC.sumstats.gz","CRP.sumstats.gz")

#enter sample prevalence of .5 to reflect that all traits were munged using the sum of effective sample size
sample.prev<-c(0.12,0.05,0.06,0.01,0.16,0.08,0.01,NA,NA,NA,NA,NA,NA,NA,NA,NA,0.10,NA,NA,0.27,NA,NA,NA,NA,NA,NA,NA,NA)

#vector of population prevalences
population.prev<-c(0.02,0.02,0.01,0.02,0.08,0.08,0.25,NA,NA,NA,NA,NA,NA,NA,NA,NA,0.09,NA,NA,0.27,NA,NA,NA,NA,NA,NA,NA,NA)
...
#name the traits
trait.names<-c("Atrial fibrillation","Heart failure","Stroke","Peripheral arterial disease","Coronary artery disease","Valvular heart disease","Metabolic dysfunction-associated steatotic liver disease","Proton density fat fraction","Liver iron corrected T1","Alanine aminotransferase","Aspartate aminotransferase","Gamma-glutamyl transferase","Alkaline phosphatase","Body mass index","Waist circumference","Body fat percentage","Type 2 diabetes","Fasting glucose","Hemoglobin A1c","Hypertension","Systolic blood pressure","Diastolic blood pressure","Non-HDL cholesterol","LDL cholesterol","HDL cholesterol","Triglyceride","Remnant cholesterol","C-reactive protein")
...
p_fdr <- matrix(p.adjust(as.vector(p), method='fdr'),ncol=28)
